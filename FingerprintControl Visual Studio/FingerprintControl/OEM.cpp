...
int oem_get_image(void)
{
	...
	if (oemp_ReceiveData(gwDevID, gbyImg8bit, sizeof gbyImg8bit) < 0)
		return OEM_COMM_ERR;
...
return OEM_COMM_ERR;
if (oemp_ReceiveData(gwDevID, gbyImgRaw, sizeof gbyImgRaw) < 0)
return OEM_COMM_ERR;
